...
<body>
    <div class="d-flex">
        ...
        <div class="content flex-grow-1 p-4">
            ...
            <?php if (empty($users)): ?>
            <p class="no-data text-center">No Users Available</p>
            <?php else: ?>
            <div class="user-table-header d-flex justify-content-between align-items-center mb-3">
                <p class="data-available mb-0">User List</p>
                <form action="/users" method="GET" class="filter-form" style="display:inline;">
