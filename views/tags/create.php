...
<body>
    <div class="d-flex">
        ...
        <div class="content flex-grow-1 p-4" role="main">
            ...
            <form action="/tags/create" method="POST" class="tag-form" id="createTagForm" novalidate>
                <!-- CSRF Token -->
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="name" name="name" required class="form-control" maxlength="50"
                        aria-describedby="nameHelp nameError" placeholder="Enter tag name (e.g., Work)">
    ...
    document.getElementById('createTagForm').addEventListener('submit', function(event) {
        ...
        // Confirmation prompt
        if (!confirm('Are you sure you want to create this tag?')) {
            event.preventDefault();
        }
    });
